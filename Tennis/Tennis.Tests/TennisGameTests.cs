...
{
    private static void CheckAllScores(ITennisGame tennisGame, int player1Score, int player2Score, string expectedScore)
    {
        ...
        Assert.That(tennisGame.GetScore(), Is.EqualTo(expectedScore));
    }
    ...
    public void Tennis1Test(int p1, int p2, string expected)
    {
        ...
        CheckAllScores(tennisGame, p1, p2, expected);
    }
}